...
/*	Value is the number of blocks before the objective passes
		<objective type="BlockDestroySDX, QuestsExpanded" id="frameShapes" value="1" phase="2"/>
		...
		<objective type="BlockDestroySDX, QuestsExpanded" id="woodChair1,officeChair01VariantHelper,woodChair1Broken" value="1" phase="2"/>


		<!-- If the base.ID does not match the passed in block, check if its a tag instead. -->
		<objective type="BlockDestroySDX, QuestsExpanded" id="deepOre" value="1" phase="2"/>

		<!-- This can also be a comma delimited list -->
		<objective type="BlockDestroySDX, QuestsExpanded" id="ore,deepOre" value="1" phase="2"/>
*/
